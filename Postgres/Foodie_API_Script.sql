...
$$
BEGIN
	IF (SELECT TO_REGCLASS('PUBLIC.STORE_TYPES')) IS NULL
	THEN 
...
$$
BEGIN
	IF (SELECT TO_REGCLASS('PUBLIC.USER_ADDRESSES')) IS NULL
	THEN 
    CREATE TABLE USER_ADDRESSES (
        ...
        IS_DEFAULT BIT(1) NOT NULL DEFAULT '0'::"BIT",
        CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
        UPDATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
        CONSTRAINT FK_USER_USER_ADDRESS FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(ID);
    );
	END IF;
END
$$
